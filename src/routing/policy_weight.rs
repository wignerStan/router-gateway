...
use crate::registry::{ModelInfo, PolicyContext, PolicyMatcher};
use crate::routing::config::WeightConfig;
use crate::routing::health::HealthStatus;
use crate::routing::metrics::AuthMetrics;
use crate::routing::weight::{AuthInfo, DefaultWeightCalculator, WeightCalculator};
...
mod tests {
    use super::*;
    use crate::registry::{
        DataSource, ModelCapabilities, PolicyRegistry, RateLimits, RoutingPolicy, templates,
    };
    ...
    fn test_policy_aware_calculator_blocked() {
        ...
        block_policy
            .filters
            .costs
            .push(crate::registry::CostCategory::UltraPremium);
