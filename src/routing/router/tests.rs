...
use super::*;
use crate::registry::{DataSource, ModelCapabilities, ModelInfo, RateLimits};
...
fn create_test_auth(id: &str) -> crate::routing::weight::AuthInfo {
    crate::routing::weight::AuthInfo {
        id: id.to_string(),
        priority: Some(0),
...
mod plan_operations {
    ...
    async fn test_router_plan_with_no_credentials() {
        ...
        let request = create_test_request(1000);
        let auths: Vec<crate::routing::weight::AuthInfo> = vec![];
