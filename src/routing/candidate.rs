...
use crate::routing::classification::{ClassifiedRequest, RequiredCapabilities};
...
mod tests {
    ...
    use super::*;
    use crate::registry::{DataSource, ModelCapabilities, RateLimits};
    ...
    fn test_candidate_builder_empty() {
        ...
        let request = ClassifiedRequest {
            ...
            format: crate::routing::classification::RequestFormat::OpenAI,
            quality_preference: crate::routing::classification::QualityPreference::Balanced,
        };
