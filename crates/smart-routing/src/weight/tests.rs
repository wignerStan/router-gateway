...
mod tests {
    ...
    mod basic_calculation {
        ...
        fn test_unhealthy_penalty() {
            ...
            let unhealthy_weight =
                calculator.calculate(&auth, Some(&metrics), HealthStatus::Unhealthy);
    ...
    mod score_factors {
        ...
        fn test_success_rate_score_with_metrics() {
            ...
            let zero_weight =
                calculator.calculate(&auth, Some(&zero_metrics), HealthStatus::Healthy);
    ...
    mod priority_and_planner {
        ...
        fn test_priority_score_edge_cases() {
            ...
            let none_weight =
                calculator.calculate(&auth_none, Some(&metrics), HealthStatus::Healthy);
            let zero_weight =
                calculator.calculate(&auth_zero, Some(&metrics), HealthStatus::Healthy);
        ...
        fn test_planner_mode_selection() {
            ...
            let full_weight =
                calculator.calculate(&auth, Some(&full_metrics), HealthStatus::Healthy);
            let sparse_weight =
